...

{
	...
	if (option == 1)
	{
		...
		outFile << setw(9) << "ID #" << setw(25) << "NAME"
				<< "BALANCE DUE\n";
		outFile << setw(9) << "----" << setw(25) <<"--------------------"
				<< "-----------" << endl;
		outFile << setw(9) << personalData[balanceIndex].id << setw(25)
				<< personalData[balanceIndex].name
				<< "$"      << right << setw(10)
				<< personalData[balanceIndex].balance;
	}//End of if statement
	...
	else if (option == 5)
	{
		...
		if (nameIndex >= 0 && nameIndex <10)
		{
			...
			outFile << setw(9) << "----" << setw(25) <<"--------------------"
					<< "-----------" << endl;
			outFile << setw(9) << personalData[nameIndex].id << setw(25)
					<< personalData[nameIndex].name
					<< "$"      << right << setw(10)
					<< personalData[nameIndex].balance;
			outFile << right;
		}//End of if statement
