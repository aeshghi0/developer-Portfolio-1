...
#include "ui_standardwarrantypurchase.h"
#include <QFile>
#include <QDebug>
#include <QTextStream>
#include "purchaseclass.h"

standardWarrantyPurchase::standardWarrantyPurchase(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::standardWarrantyPurchase)
{
    ui->setupUi(this);

    ui->Heading->setText("Goon Squad Robots | Standard Warranty Purchase");
...
standardWarrantyPurchase::~standardWarrantyPurchase()
{
    delete ui;
}

void standardWarrantyPurchase::on_CartButton_clicked()
{
...
void standardWarrantyPurchase::on_CardPushButton_clicked()
{
    if (itemsInCart > 0)
    {
