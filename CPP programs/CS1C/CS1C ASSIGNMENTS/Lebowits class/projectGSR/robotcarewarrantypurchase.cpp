...
#include "ui_robotcarewarrantypurchase.h"
#include <QFile>
#include <QTextStream>
#include <QDebug>
#include "purchaseclass.h"

robotCareWarrantyPurchase::robotCareWarrantyPurchase(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::robotCareWarrantyPurchase)
{
    ui->setupUi(this);
    ui->Heading->setText("Goon Squad Robots | Robot Care Purchase");
    ...
    ui->line_edit->setPlaceholderText("Must Enter a Valid Qunatity To Cart");



}

robotCareWarrantyPurchase::~robotCareWarrantyPurchase()
{
    delete ui;
}

void robotCareWarrantyPurchase::on_CartButton_clicked()
{
    ...
    if(itemsInCart > 0)
    {
        ...
        runningCost = static_cast<double>(itemsInCart) * 299.99;
...
void robotCareWarrantyPurchase::on_CardPushButton_clicked()
{
    if (itemsInCart > 0)
    {
