...
#include "ui_purchasemaintanenceplan.h"
#include <QTextStream>
#include "purchaseclass.h"
#include <QFile>
#include <QDebug>

purchaseMaintanencePlan::purchaseMaintanencePlan(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::purchaseMaintanencePlan)
{
    ui->setupUi(this);
    ui->Heading->setText("Goon Squad Robots | Maintanence Plan Purchase");
...
purchaseMaintanencePlan::~purchaseMaintanencePlan()
{
    delete ui;
}

void purchaseMaintanencePlan::on_CartButton_clicked()
{
    ...
    if(itemsInCart > 0)
    {
        ...
        runningCost = static_cast<double>(itemsInCart) * 500;
...
void purchaseMaintanencePlan::on_CardPushButton_clicked()
{
    if (itemsInCart > 0)
    {
