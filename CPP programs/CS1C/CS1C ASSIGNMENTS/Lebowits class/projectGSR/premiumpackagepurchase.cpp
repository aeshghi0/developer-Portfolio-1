...
#include "ui_premiumpackagepurchase.h"
...
premiumPackagePurchase::premiumPackagePurchase(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::premiumPackagePurchase)
{
    ui->setupUi(this);
...
premiumPackagePurchase::~premiumPackagePurchase()
{
    delete ui;
}

void premiumPackagePurchase::on_CartButton_clicked()
{
    ...
    if(itemsInCart > 0)
    {
        ...
        runningCost = static_cast<double>(itemsInCart) * 4999.99;
...
void premiumPackagePurchase::on_CardPushButton_clicked()
{
    if (itemsInCart > 0)
    {
